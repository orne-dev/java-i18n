...
@ContextConfiguration(locations={ "/dev/orne/i18n/spring/spring-context-alt.xml" })
class SpringXmlConfigurationAltIT {

    private static final Locale XX_LOCALE = new Locale("xx");
    private static final Locale YY_LOCALE = new Locale("yy");
    private static final Locale ZZ_LOCALE = new Locale("zz");
    ...
    private static final Object ALT_BUNDLE_VALUE_DEFAULT = "dev/orne/i18n/test-messages-alt.properties";
    private static final Object ALT_BUNDLE_VALUE_YY = "dev/orne/i18n/test-messages-alt_yy.properties";
    private static final Object ALT_BUNDLE_VALUE_ZZ = "dev/orne/i18n/test-messages-alt_zz.properties";
    ...
    /**
     * Tests alternative {@code MessageSource} configuration.
     */
    @Test
    void testAltMessageSource() {
        final MessageSource messageSource = appContext.getBean("altMessageSource", MessageSource.class);
        assertNotNull(messageSource);
        assertEquals(ALT_BUNDLE_VALUE_DEFAULT, messageSource.getMessage(
                BUNDLE_PROP,
                new Object[0],
                XX_LOCALE));
        assertEquals(ALT_BUNDLE_VALUE_DEFAULT, messageSource.getMessage(
                ...
                new Object[0],
                Locale.ENGLISH));
        assertEquals(ALT_BUNDLE_VALUE_YY, messageSource.getMessage(
                BUNDLE_PROP,
                new Object[0],
                YY_LOCALE));
        assertEquals(ALT_BUNDLE_VALUE_ZZ, messageSource.getMessage(
                BUNDLE_PROP,
                new Object[0],
                ZZ_LOCALE));
    }
    ...
    void testAlternativeI18nResources() {
        ...
        assertEquals(ALT_BUNDLE_VALUE_DEFAULT, resources.getMessage(
                FAIL_VALUE,
                BUNDLE_PROP,
                XX_LOCALE));
        assertEquals(ALT_BUNDLE_VALUE_DEFAULT, resources.getMessage(
                ...
                BUNDLE_PROP,
                Locale.ENGLISH));
        assertEquals(ALT_BUNDLE_VALUE_YY, resources.getMessage(
                FAIL_VALUE,
                BUNDLE_PROP,
                YY_LOCALE));
        assertEquals(ALT_BUNDLE_VALUE_ZZ, resources.getMessage(
                FAIL_VALUE,
                BUNDLE_PROP,
                ZZ_LOCALE));
    }
