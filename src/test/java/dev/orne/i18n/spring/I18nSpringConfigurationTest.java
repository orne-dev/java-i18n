...
class I18nSpringConfigurationTest {
    ...
    /**
     * Test {@link I18nSpringConfiguration#I18nSpringConfiguration()}.
     */
    @Test
    void testDefaultConstructor() {
        assertDoesNotThrow(() -> new I18nSpringConfiguration());
    }

    /**
     * Test {@link I18nSpringConfiguration.Selector#selectImports(AnnotationMetadata)}.
     */
    @ParameterizedTest
    ...
    throws InterruptedException {
        ...
        assertEquals(I18nSpringBaseConfiguration.class.getName(), test.result[0]);
    ...
    implements Runnable {
        ...
        @Override
        public void run() {
            I18nSpringConfiguration.Selector selector = new I18nSpringConfiguration.Selector();
